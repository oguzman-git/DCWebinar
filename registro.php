        ...
        <form id="registro" class="registro" action="validar_registro.php" method="post">
                ...
                <ul class="lista-precios clearfix">
                    ...
                    <li>
                        <div class="tabla-precio">
                            ...
                            <div class="orden">
                                <label for="pase_completo">Boletos deseados:</l abel>
                    ...
                    <li>
                        <div class="tabla-precio">
                            ...
                            <div class="orden">
                                <label for="pase_dosdias">Boletos deseados:</l abel>
            ...
            <div id="resumen" class="resumen clearfix">
                ...
                <div class="caja clearfix">
                    <div class="extras">
                        <div class="orden">
                            <label for="camisa-evento">Camisa del evento $10 <small>(promocion 7% dcto.)</small></label>
                            <input type="number" min="0" id="camisa-evento" name="pedido_camisas" size="3" placeholder="0">
                        </div>
                        <!--.orden-->
                        <div class="orden">
                            <label for="etiquetas">Paquete de 10 etiquetas $2 <small>(HTML, CSS, JavaScript, Chrome)</small></label>
